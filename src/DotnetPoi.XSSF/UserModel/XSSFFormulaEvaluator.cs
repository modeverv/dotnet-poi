...
/// <summary>
/// Small XSSF formula evaluator slice.
/// Ported from the FormulaEvaluator surface; full POI formula parity remains incremental Phase 5 work.
/// </summary>
public sealed class XSSFFormulaEvaluator : IFormulaEvaluator
{
    ...
    internal XSSFFormulaEvaluator(XSSFWorkbook workbook)
    {
        _workbook = workbook;
    }
    ...
    public CellValue evaluate(ICell cell)
    {
        return cell.getCellType() == CellType.Formula
            ? EvaluateFormulaCell((XSSFCell)cell, new HashSet<XSSFCell>())
            : CellToValue((XSSFCell)cell);
    }
    ...
    public CellType evaluateFormulaCell(ICell cell)
    {
        ...
        var xssfCell = (XSSFCell)cell;
        var value = EvaluateFormulaCell(xssfCell, new HashSet<XSSFCell>());
        xssfCell.SetFormulaCachedValue(value);
    ...
    public ICell evaluateInCell(ICell cell)
    {
        ...
        var value = EvaluateFormulaCell((XSSFCell)cell, new HashSet<XSSFCell>());
        cell.setCellFormula(null);
        ApplyValue(cell, value);
        return cell;
    }

    private CellValue EvaluateFormulaCell(XSSFCell cell, HashSet<XSSFCell> evaluationStack)
    {
    ...
    private CellValue ResolveCell(XSSFSheet sheet, int rowIndex, int columnIndex, HashSet<XSSFCell> evaluationStack)
    {
    ...
    private static CellValue CellToValue(XSSFCell cell)
    {
    ...
    {
        private readonly XSSFFormulaEvaluator _evaluator;
        private readonly XSSFSheet _sheet;
        private readonly HashSet<XSSFCell> _evaluationStack;
        private readonly string _formula;
        private int _pos;

        internal Parser(XSSFFormulaEvaluator evaluator, XSSFSheet sheet, HashSet<XSSFCell> evaluationStack, string formula)
        {
