...
public sealed class XSLFPictureData
{
    ...
    internal XSLFPictureData(byte[] data, int format, int index)
    {
    ...
    internal static int FormatFromExtension(string ext) => ext switch
    {
