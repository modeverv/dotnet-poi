...
public sealed class XSSFDrawing
{
    ...
    private readonly List<string> _preservedRawAnchors = new();
    ...
    internal IReadOnlyList<string> PreservedRawAnchors => _preservedRawAnchors;

    internal void addPreservedRawAnchor(string rawXml)
    {
        _preservedRawAnchors.Add(rawXml);
    }
    ...
    public XSSFPicture createPicture(XSSFClientAnchor anchor, int pictureIndex)
    {
        ...
        var relationshipId = "rId" + (_pictures.Count + 1).ToString(CultureInfo.InvariantCulture);
