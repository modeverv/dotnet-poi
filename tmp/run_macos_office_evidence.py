    ...
    return [
        {
            "kind": "xlsx",
            "app": "excel",
            "source": existing("examples/output/usage-workbook.xlsx"),
            "password": None,
            "encrypted": False,
        },
        {
            ...
            "app": "excel",
            "source": existing(
                "tests/DotnetPoi.Interop.Tests/fixtures/from-dotnet-poi/phase-xlsm-interop.xlsm",
                "tests/test-files/example.xlsm",
            ),
            "password": None,
            "encrypted": False,
        },
        {
            "kind": "encrypted xlsx",
            "app": "excel",
            "source": existing("examples/output/phase3_4-agile-encrypted-example.xlsx"),
            "password": "f",
            "encrypted": True,
        },
        {
        ...
        },
        {
            "kind": "docx",
            "app": "word",
            "source": existing("examples/output/usage-document.docx"),
            "password": None,
            "encrypted": False,
        },
        {
            ...
            "app": "word",
            "source": existing(
                "tests/DotnetPoi.Interop.Tests/fixtures/from-dotnet-poi/phase-docm-interop.docm",
                "tests/test-files/example.docm",
            ),
            "password": None,
            "encrypted": False,
        },
        ...
        },
        {
            "kind": "pptx",
            "app": "powerpoint",
            "source": existing("examples/output/usage-presentation.pptx"),
            "password": None,
            "encrypted": False,
        },
        {
            ...
            "app": "powerpoint",
            "source": existing(
                "tests/DotnetPoi.Interop.Tests/fixtures/from-dotnet-poi/phase-pptm-interop.pptm",
                "tests/test-files/example.pptm",
            ),
            "password": None,
            "encrypted": False,
        },
        ...
        },
        {
            "kind": "xls",
            "app": "excel",
            "source": existing("examples/output/phase4-hssf-xls-example.xls"),
            "password": None,
            "encrypted": False,
        },
        {
            "kind": "encrypted xlsx edge",
            "app": "excel",
            "source": existing("examples/output/edge-encrypted-sparse.xlsx"),
            "password": "edge-pass",
            "encrypted": True,
        },
    ]
