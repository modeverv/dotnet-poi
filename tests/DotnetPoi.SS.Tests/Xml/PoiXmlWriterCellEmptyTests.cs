...
public class PoiXmlWriterCellEmptyTests
{
    [Fact]
    public void Write_Rels_CellEmpty_MatchesFixture()
    {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty___rels__.rels"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_DocPropsApp_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__docProps__app.xml"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_DocPropsCore_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__docProps__core.xml"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_WorkbookRels_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__xl___rels__workbook.xml.rels"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_SharedStrings_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__xl__sharedStrings.xml"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_Styles_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__xl__styles.xml"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_Workbook_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__xl__workbook.xml"));
        Assert.Equal(expected, builder.ToString());
    }

    [Fact]
    public void Write_Worksheet_CellEmpty_MatchesFixture()
    {
        var builder = new StringBuilder();
        using (var writer = new PoiXmlWriter(new StringWriter(builder)))
        {
            ...
            writer.WriteAttributeString("ref", "A1:B2");
            writer.WriteEndElement();
        ...
        var expected = File.ReadAllText(XmlFixturePaths.GetFixturePath("cell-empty__xl__worksheets__sheet1.xml"));
        Assert.Equal(expected, builder.ToString());
    }
