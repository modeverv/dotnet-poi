# DotnetPOI v1.0.0-87943d5-macos macOS Office Evidence

- Project version: `1.0.0`
- Git revision: `87943d5`
- Captured: `2026-05-08 18:25:49 +0900` - `2026-05-08 18:29:44 +0900`
...
- Overall: `PASS`
- Result counts: `12` pass, `0` missing fixture, `0` permission required, `0` fail
...
| xls | excel | tools/manual-verification/generated-documents/manual-simple.xls | no | PASS | PASS | PASS | <img src="images/10-xls-manual-simple.png" width="320" alt="xls macOS Office evidence"> |  |
| doc | word | tools/manual-verification/generated-documents/manual-simple.doc | no | PASS | PASS | PASS | <img src="images/11-doc-manual-simple.png" width="320" alt="doc macOS Office evidence"> |  |
| ppt | powerpoint | tools/manual-verification/generated-documents/manual-simple.ppt | no | PASS | PASS | PASS | <img src="images/12-ppt-manual-simple.png" width="320" alt="ppt macOS Office evidence"> |  |
